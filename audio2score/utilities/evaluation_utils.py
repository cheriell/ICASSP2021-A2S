...
class Eval():
    ...
    @staticmethod
    def framewise_evaluation(output, target):
    ...
    @staticmethod
    def get_notes_intervals(piano_roll, hop_time=0.01):
    ...
    @staticmethod
    def notewise_evaluation(piano_roll_target, piano_roll_output, hop_time):
